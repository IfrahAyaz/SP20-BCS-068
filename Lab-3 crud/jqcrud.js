$(function () {
  ...
  $("#updateSave").click(function () {
    ...
    $.ajax({
      url: "https://usman-cui-recipies.herokuapp.com/products-api/" + id,
      data: { title, body },
      method: "PUT",
...
function handleUpdate() {
  ...
  $.get(
    "https://usman-cui-recipies.herokuapp.com/products-api/" + id,
    function (response) {
...
function addRecipe() {
  ...
  var body = $("#body").val();
  $.ajax({
    url: "https://usman-cui-recipies.herokuapp.com/products-api",
    method: "POST",
    data: { title, body },
    success: function (response) {
      console.log(response);
